...
public class End2endIT {
    ...
    static String testUser1 = "cyx123"+ UUID.randomUUID();
    ...
    public void enrollUsersSetup(SampleStore sampleStore) throws Exception {
        ...
        for (SampleOrg sampleOrg : testSampleOrgs) {
            ...
            HFCAClient ca = HFCAClient.createNewInstance("ca.example.com","http://192.168.8.15:7054",null);
            ...
            if (infoName != null && !infoName.isEmpty()) {
                assertEquals(ca.getCAName(), ca.info().getCAName());
            }
